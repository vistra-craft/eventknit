          ...
          <div className="flex flex-col lg:flex-row lg:items-end gap-6">
            ...
            <div className="flex gap-3 pointer-events-auto">
              <Button
                ...
                className={`bg-glass-bg backdrop-blur-sm border-glass-border hover:bg-glass-bg/80 ${isFavorited ? 'text-red-400' : 'text-foreground'}`}
              >
              ...
              <Button
                variant="secondary"
                size="lg"
                className="bg-glass-bg backdrop-blur-sm border-glass-border text-foreground hover:bg-glass-bg/80"
              >
