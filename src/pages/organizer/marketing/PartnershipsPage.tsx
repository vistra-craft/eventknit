      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Manage sponsors, venues, media partners, and vendor relationships
          </p>
        </div>
      ...
      {activeTab === "analytics" && (
        <Card>
          <CardContent className="p-12 text-center">
            ...
            <h3 className="text-lg font-medium text-foreground mb-2">Partnership Analytics</h3>
            <p className="text-muted-foreground mb-4">
              Detailed analytics and insights for your partnership performance
            </p>
            <Button variant="outline">
