    ...
    return (
      <div className="bg-white border border-gray-200 rounded-lg shadow-lg p-8 max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8 pb-6 border-b border-gray-200">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-2">{selectedTemplate.branding.companyName}</h1>
        ...
        <div className="mt-12 pt-6 border-t border-gray-200 text-center">
          <p className="text-sm text-gray-500">
            This partnership agreement is generated by EventKnit Platform
          </p>
