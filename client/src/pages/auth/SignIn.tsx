      ...
      <div className="container mx-auto px-6 py-12 pt-32">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-3 mb-6">
            <Button
              variant="outline"
              className="w-full h-12 flex items-center gap-3 border-gray-300 hover:bg-transparent hover:border-2 hover:border-gray-300 hover:text-foreground"
          ...
          <div className="mt-8 text-center">
            <p className="text-xs text-muted-foreground">
              ...
              <Link to="/terms-of-service" className="text-foreground underline hover:no-underline">Terms & Conditions</Link>
              {' '}and{' '}
              <Link to="/privacy-policy" className="text-foreground underline hover:no-underline">Privacy Policy</Link>
            </p>
          </div>
              </div>
            </div>
