  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-primary/5 via-background to-muted/10 flex items-center justify-center p-4 relative">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-none p-6 space-y-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
            {/* Attendee card */}
            <Card
              className="border-0 bg-white rounded-2xl shadow-none hover:shadow-md hover:-translate-y-0.5 transition-all duration-300 cursor-pointer"
