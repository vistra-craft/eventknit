  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        {/* Quick Actions */}
        {!statsLoading && (
          <section aria-labelledby="quick-actions-heading" className="border-t border-border/50 pt-8">
            <div className="mb-5">
              <h2
              ...
              <p className="text-xs text-muted-foreground mt-1">Common administrative tasks</p>
            </div>
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
              <Link
                to="/admin/events/create"
                className="group flex items-center gap-3 rounded-xl border border-border/50 bg-card-surface p-4 transition-all duration-200 hover:border-primary/50 hover:shadow-md hover:-translate-y-0.5"
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Add new event</p>
                </div>
              </Link>
              <Link
                to="/admin/analytics"
                className="group flex items-center gap-3 rounded-xl border border-border/50 bg-card-surface p-4 transition-all duration-200 hover:border-primary/50 hover:shadow-md hover:-translate-y-0.5"
              >
                <div className="rounded-lg bg-indigo-500/10 p-2.5 group-hover:bg-indigo-500/15 transition-colors">
              ...
              <Link
                ...
                className="group flex items-center gap-3 rounded-xl border border-border/50 bg-card-surface p-4 transition-all duration-200 hover:border-primary/50 hover:shadow-md hover:-translate-y-0.5"
              >
                <div className="rounded-lg bg-teal-500/10 p-2.5 group-hover:bg-teal-500/15 transition-colors">
                  <Users className="h-5 w-5 text-teal-500" />
                </div>
                <div>
                  <p className="text-sm font-semibold text-foreground">Manage Users</p>
                  <p className="text-xs text-muted-foreground">User directory</p>
                </div>
              </Link>
              <Link
                to="/admin/settings"
                className="group flex items-center gap-3 rounded-xl border border-border/50 bg-card-surface p-4 transition-all duration-200 hover:border-primary/50 hover:shadow-md hover:-translate-y-0.5"
              >
                <div className="rounded-lg bg-slate-500/10 p-2.5 group-hover:bg-slate-500/15 transition-colors">
