      ...
      <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as "all" | "unread" | "read")}>
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          >
            ...
            <option value="STAFF_ASSIGNED_TO_EVENT">Staff Assignments</option>
          </select>
            ...
            <EmptyState
              ...
              description={
                activeTab === "unread"
                  ...
                  : "No notifications yet. You'll receive updates about platform events, user activity, and system alerts here."
              }
            />
          ) : (
