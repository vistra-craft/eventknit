...
const OrganizerStaffDashboard = () => {
  ...
  return (
    <div className="space-y-4 md:space-y-6 p-4 md:p-0">
      {/* Header */}
      <div>
        <h1 className={`${isMobile ? 'text-2xl' : 'text-3xl'} font-bold`}>Staff Dashboard</h1>
        <p className={`${isMobile ? 'text-sm' : ''} text-muted-foreground`}>
          Manage your assigned events and view analytics
        </p>
      </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {assignedEvents.length > 0 ? assignedEvents[0]?.role || 'N/A' : 'N/A'}
            </div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid gap-3 md:gap-4 grid-cols-1 md:grid-cols-3">
            ...
            <Link to="/organizer/analytics/events">
              <Button className="w-full" variant="outline" size={isMobile ? 'default' : 'lg'}>
                <TrendingUp className={`${isMobile ? 'mr-2 h-4 w-4' : 'mr-2 h-5 w-5'}`} />
                Analytics
              </Button>
            </Link>
...
export default OrganizerStaffDashboard;
