...
You have the right to know about automated decisions that affect you and to request manual review of any decision made by automated means. To exercise this right, contact us at privacy@eventknit.com.`
  },
  {
    id: "processors",
    number: "13",
    title: "Data Processors and Partners",
...
We maintain an up-to-date list of our sub-processors and conduct regular assessments to ensure they meet our data protection standards. We ensure that all service providers comply with applicable data protection laws and provide adequate safeguards for your personal data.`
  },
  {
    id: "organizer-data",
    number: "14",
    title: "Organizer Access to Attendee Data",
      ...
      <div className="border-b border-border">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-10">
          ...
          <p className="text-sm text-muted-foreground mt-3 max-w-3xl">
            This policy describes how EventKnit collects, uses, stores, and protects your personal information. We are committed to transparency and to safeguarding your privacy.
          </p>
        </div>
      </div>
