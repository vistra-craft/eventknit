    ...
    <footer className="bg-primary/5">
      <div className="container mx-auto px-6 py-4">
        ...
        <div className="flex justify-center space-x-4 mb-2">
          <a
            href="#"
            className="flex items-center justify-center w-8 h-8 rounded-full bg-eventknit text-eventknit-foreground hover:bg-eventknit/90 transition-colors"
            aria-label="Facebook"
          >
            <Facebook size={16} />
          </a>
          ...
          <div className="text-center md:text-left">
            <ul className="space-y-1">
              <li>
                <Link
                  to="/"
                  className="text-muted-foreground hover:text-nav-hover transition-colors text-sm"
                >
                  Discover Events
                </Link>
              </li>
