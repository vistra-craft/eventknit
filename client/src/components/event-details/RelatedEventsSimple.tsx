      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {relatedEvents.map((event) => (
          <div
            ...
            className="group cursor-pointer overflow-hidden rounded-xl border border-border bg-white shadow-sm hover:shadow-md transition-all duration-200"
          >
            {/* Event Image */}
            <div className="relative h-48 overflow-hidden">
              ...
              {event.category && (
                <div className="absolute top-3 left-3">
                  <span className="px-2 py-1 bg-white/90 text-foreground backdrop-blur-sm rounded-full text-xs font-semibold shadow-sm">
                    {event.category}
                  </span>
                </div>
              )}
