 ...
 * @access  Private (ADMIN+)
 */
router.post('/payments/sync', requireMinRole(UserRole.ADMIN), FinancialController.syncPayments);
 ...
 * @access  Private (ADMIN+)
 */
router.get('/payments', requireMinRole(UserRole.ADMIN), FinancialController.getPaymentTransactions);
 ...
 * @access  Private (ADMIN+)
 */
router.get('/payments/:id', requireMinRole(UserRole.ADMIN), FinancialController.getPaymentTransaction);
 ...
 * @access  Private (ADMIN+)
 */
router.get('/platform-fees', requireMinRole(UserRole.ADMIN), FinancialController.getPlatformFees);
 ...
 * @access  Private (ADMIN+)
 */
router.get('/platform-fees/summary', requireMinRole(UserRole.ADMIN), FinancialController.getPlatformFeeSummary);
 ...
 * @access  Private (ADMIN+)
 */
router.post('/disbursements', requireMinRole(UserRole.ADMIN), FinancialController.createDisbursement);

/**
 * @route   GET /api/v1/admin/finance/disbursements
 * @desc    Get disbursements (by organizer or event)
 * @access  Private (ADMIN+ or ORGANIZER for own disbursements)
 */
 ...
 * @access  Private (ADMIN+ or ORGANIZER for own summary)
 */
 ...
 * @access  Private (ADMIN+ or ORGANIZER for own disbursement)
 */
 ...
 * @access  Private (ADMIN+)
 */
router.post('/disbursements/:id/process', requireMinRole(UserRole.ADMIN), FinancialController.processDisbursement);
 ...
 * @access  Private (ADMIN+)
 */
router.post('/disbursements/:id/complete', requireMinRole(UserRole.ADMIN), FinancialController.completeDisbursement);
 ...
 * @access  Private (ADMIN+)
 */
router.post('/refunds', requireMinRole(UserRole.ADMIN), FinancialController.createRefund);
 ...
 * @access  Private (ADMIN+)
 */
router.get('/refunds', requireMinRole(UserRole.ADMIN), FinancialController.getRefunds);
 ...
 * @access  Private (ADMIN+)
 */
router.get('/refunds/summary', requireMinRole(UserRole.ADMIN), FinancialController.getRefundSummary);

/**
 * @route   GET /api/v1/admin/finance/refunds/:id
 * @desc    Get refund by ID
 * @access  Private (ADMIN+ or ORGANIZER for own event refunds)
 */
 ...
 * @access  Private (ADMIN+)
 */
router.post('/refunds/:id/process', requireMinRole(UserRole.ADMIN), FinancialController.processRefund);
 ...
 * @access  Private (ADMIN+)
 */
router.post('/refunds/:id/complete', requireMinRole(UserRole.ADMIN), FinancialController.completeRefund);
 ...
 * @access  Private (ADMIN+)
 */
router.post('/reconciliations', requireMinRole(UserRole.ADMIN), FinancialController.createReconciliation);
 ...
 * @access  Private (ADMIN+)
 */
router.get('/reconciliations', requireMinRole(UserRole.ADMIN), FinancialController.getReconciliations);
 ...
 * @access  Private (ADMIN+)
 */
router.get('/reconciliations/:id', requireMinRole(UserRole.ADMIN), FinancialController.getReconciliation);
 ...
 * @access  Private (ADMIN+)
 */
router.post('/reconciliations/:id/auto-fix', requireMinRole(UserRole.ADMIN), FinancialController.autoFixReconciliation);
