    ...
    try {
      ...
      const template = await prisma.badgeTemplate.create({
        data: {
          ...
          elements: (data.elements ?? []) as unknown as Prisma.InputJsonValue,
  ...
  static async updateTemplate(id: string, data: UpdateBadgeTemplateInput) {
    try {
      ...
      const template = await prisma.badgeTemplate.update({
        ...
        data: {
          ...data,
          elements: data.elements as unknown as Prisma.InputJsonValue | undefined,
          updatedAt: new Date(),
        },
      });
    ...
    try {
      ...
      const template = await prisma.badgeTemplate.create({
        data: {
          ...
          elements: original.elements as unknown as Prisma.InputJsonValue,
          isDefault: false,
